...
# 环境变量
UUID = os.environ.get('UUID', 'fdbde7b8-b15c-4f93-9a9d-8c640b0820fe')   # 节点UUID
...
DOMAIN = os.environ.get('DOMAIN', 'streaamlit-ynasvh4yqyyyrfu3gktdqe.streamlit.app')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
